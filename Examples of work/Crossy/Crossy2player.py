...
class Game2:
    ...
    def gameloop(self,level_speed):
        ...
        player = Player('./imgs/players/p.png','./imgs/players/pp.png',280,650, 50, 50)
        player2 = Player('./imgs/players/p2.png','./imgs/players/pp2.png',875,650, 50, 50)
        ...
        treasure = GameObject('./imgs/t.png','./imgs/t.png',280, 50, 50, 50)
        treasure2 = GameObject('./imgs/t.png','./imgs/t.png',875, 50, 50, 50)
...
# Runs the game
new_game2 = Game2('./imgs/backgrounds/bb.png',SCREEN_TITLE,SCREEN_WIDTH,SCREEN_HEIGHT)
new_game2.gameloop(1)
